                    ...
                    <div className="w-full flex flex-col md:flex-row justify-between gap-6 mx-auto">
                        ...
                        <div className="md:w-[50%] w-full">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    type="submit"
                                    className="text-white absolute end-2.5 bottom-2.5 bg-[#252422]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-[#252422] dark:focus:ring-blue-800"
                                >
                                    Search
                                </button>
                            </div>
                            ...
                            {filteredCustomers.map((customer) => {
                                ...
                                return customerTransactions.map((transaction) => (
                                    <tr key={transaction.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td className="px-6 text-center font-bold py-4">{customer.id}</td>
